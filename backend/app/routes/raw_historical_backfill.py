...
from backend.app.services.raw_historical_backfill import backfill_raw_historical_data
...
def run_raw_historical_backfill() -> (
    HistoricalBackfillResponse | None
):
    try:
        return backfill_raw_historical_data()
